    ...
    <nav class="bg-orange-100 border-gray-200 px-2 sm:px-4 py-2.5 rounded dark:bg-gray-800">
        <div class="container flex flex-wrap justify-between items-center mx-auto ">
            <a href="/" class="flex items-center">
                <Image src="/loco.png" class="mr-3 h-6 sm:h-9" alt="Flowbite Logo" />
            ...
            <div class="hidden w-full md:block md:w-auto" id="mobile-menu ">
                <ul class="flex flex-col mt-0 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium font-mono">
                    ...
                    <li>
                        <a href="https://www.facebook.com/sadsada.hanlun/" class="block py-2 pr-4 pl-3 text-gray-700 hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-gray-400 md:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent">Contact_Us</a>
                    </li>
                </ul>
            </div>
        </div>
